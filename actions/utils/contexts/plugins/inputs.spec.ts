...
import { toBool, toString } from "@utils/converters"
import { asMock, mockEnvironment } from "@utils/mocks"

import { ContextBuilder } from ".."
import { InputContextPlugin } from "./inputs"

jest.mock("@actions/core")

describe("utils.contexts.plugins.inputs", () => {
