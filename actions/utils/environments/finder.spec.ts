import { mockEnvironment } from "@utils/mocks/mock"

import { findEnvironment as findEnvironmentironment } from "."
...
describe("utils.environments.finder", () => {
  ...
  test.each([
    ...
    (name, object, expected) => {
      mockEnvironment(object, () => {
        const output = findEnvironmentironment(name)
  ...
  test("find environment with defaults value", () => {
    ...
    mockEnvironment(environment, () => {
      const output = findEnvironmentironment(["invalid"], "example")
